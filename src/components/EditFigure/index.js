...
const EditFigure = ({coordinates, isEditorActive, currentFigure, currentPointIndex, startEditPoint, endEditPoint}) => {
    ...
    return (<div className={styles.EditFigure}>
        <h4>Current:</h4>
        <h6>figure - ({currentFigure.index})</h6>
        <h6>point - ({currentPointIndex + 1})</h6>
        {outputCoordinates}
        <Button className={styles.EditButton} disabled={isEditorActive} onClick={startEditPoint}
                variant="outline-light">start edit point</Button>
        <Button className={styles.EditButton} disabled={!isEditorActive} onClick={endEditPoint} variant="outline-light">finish
            edit point</Button>
